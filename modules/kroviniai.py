...
def show(conn, c):
    ...
    # Užtikrinti, kad visi reikalingi laukai egzistuotų DB
    expected = {
        'klientas': 'TEXT',
    ...
    if sel is None:
        ...
        if df.empty:
            ...
            # Sudaryti pakrovimo ir iškrovimo vietų apjunginius
            ...
            # Rodyti tik FIELD_ORDER laukus
            df_disp = df[FIELD_ORDER].fillna("")

            # Filtrai virš stulpelių
