...
def show(conn, c):
    ...
    # 1) Užtikriname, kad visi reikiami stulpeliai egzistuotų
    ...
    with st.form("krovinio_forma", clear_on_submit=False):
        ...
        # Vilkikas + automatiškai rodoma priekaba
    ...
    if submit:
        ...
        if pak_data > isk_data:
            ...
            # Insert – dabar sutampa su lentelės schema
            c.execute("""
